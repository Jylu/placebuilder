class API
  class Communities < Base
    ...
    # Returns a set of communities with longitudes and latitudes
    get "/locations" do
      control_access :public
      community_data = Community.all.map { |community|
        [community.slug, community.latitude.to_i, community.longitude.to_i]
      }
      serialize community_data
    end
