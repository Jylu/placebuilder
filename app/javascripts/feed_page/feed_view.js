var FeedView = CommonPlace.View.extend({
  ...
  initialize: function(options) {
    ...
    this.subViews = [profile, about, header, resource, resourceNav, actions, sidebar, adminBar];
  },
